...
export const api = {
  ...
  applyManifest: (contextName: string, kind: string, namespace: string, name: string, yaml: string) =>
    invoke<string>("apply_manifest", { contextName, kind, namespace, name, yaml }),
